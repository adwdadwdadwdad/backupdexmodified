...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-30),Size=UDim2.new(0,105,0,20),Text="v2.5.1\nDeveloped by Moon",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
